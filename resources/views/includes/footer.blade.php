<footer class="footer">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 width-23">
              ...
              <div>
                ...
                <p class="font-md color-gray-900 mt-20 mb-10">Secured Payment Gateways</p><img src="{{asset('assets/imgs/template/payment-method.png')}}" alt="Ecom">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="footer-2">
        <div class="footer-bottom-1">
          <div class="container">
            <div class="footer-2-top mb-20"><a href="index.html"><img alt="Ecom" src="{{asset('assets/imgs/template/logo-2.svg')}}"></a><a class="font-xs color-gray-1000" href="#">EcomMarket.com</a><a class="font-xs color-gray-1000" href="#">Ecom Partners</a><a class="font-xs color-gray-1000" href="#">Ecom Bussiness</a><a class="font-xs color-gray-1000" href="#">Ecom Factory</a></div>
    ...
    <script src="{{ asset('js/vendors/modernizr-3.6.0.min.js') }}"></script>
