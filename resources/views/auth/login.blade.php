   ...
   @include('includes.leftsidebar')
    ...
    <form method="POST" action="{{ route('login-submit') }}">
        ...
        <div class="form-register mt-30 mb-30">
            ...
            <div class="mt-20"><span class="font-xs color-gray-500 font-medium">Don't have an account?</span><a class="font-xs color-brand-3 font-medium" href="{{ route('register') }}">Sign Up</a></div>
        </div>
    </form>
</div>
